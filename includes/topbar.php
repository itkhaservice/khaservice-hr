<header class="main-header">
    ...
    <div class="user-info">
        ...
        <div class="user-dropdown">
            <a href="<?php echo BASE_URL; ?>admin/change_password.php"><i class="fas fa-key"></i> Đổi mật khẩu</a>
            <a href="<?php echo BASE_URL; ?>admin/logout.php" style="color: #dc2626;"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
        </div>
    </div>
</header>
