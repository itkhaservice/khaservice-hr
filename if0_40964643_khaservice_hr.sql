...
-- Thời gian đã tạo: Th1 22, 2026 lúc 09:49 PM
-- Phiên bản máy phục vụ: 11.4.9-MariaDB
...
--
-- Cơ sở dữ liệu: `if0_40964643_khaservice_hr`
--
...
--
-- Cấu trúc bảng cho bảng `attendance_locks`
--
...
--
-- Đang đổ dữ liệu cho bảng `attendance_locks`
--
...
--
-- Cấu trúc bảng cho bảng `attendance_symbols`
--
...
--
-- Đang đổ dữ liệu cho bảng `attendance_symbols`
--
...
--
-- Cấu trúc bảng cho bảng `document_settings`
--
...
--
-- Đang đổ dữ liệu cho bảng `document_settings`
--
...
--
-- Cấu trúc bảng cho bảng `employee_leave_balances`
--
...
--
-- Đang đổ dữ liệu cho bảng `employee_leave_balances`
--
...
--
-- Cấu trúc bảng cho bảng `employee_status_history`
--
...
--
-- Cấu trúc bảng cho bảng `project_positions`
--
...
--
-- Đang đổ dữ liệu cho bảng `project_positions`
--
...
--
-- Cấu trúc bảng cho bảng `project_support_allowances`
--
...
--
-- Chỉ mục cho bảng `attendance_locks`
--
...
--
-- Chỉ mục cho bảng `attendance_symbols`
--
...
--
-- Chỉ mục cho bảng `document_settings`
--
...
--
-- Chỉ mục cho bảng `employee_leave_balances`
--
...
--
-- Chỉ mục cho bảng `employee_status_history`
--
...
--
-- Chỉ mục cho bảng `project_positions`
--
...
--
-- Chỉ mục cho bảng `project_support_allowances`
--
...
--
-- AUTO_INCREMENT cho bảng `attendance_locks`
--
ALTER TABLE `attendance_locks`
...
--
-- AUTO_INCREMENT cho bảng `attendance_symbols`
--
ALTER TABLE `attendance_symbols`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- AUTO_INCREMENT cho bảng `document_settings`
--
ALTER TABLE `document_settings`
...
--
-- AUTO_INCREMENT cho bảng `employee_leave_balances`
--
ALTER TABLE `employee_leave_balances`
...
--
-- AUTO_INCREMENT cho bảng `employee_status_history`
--
ALTER TABLE `employee_status_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `project_positions`
--
ALTER TABLE `project_positions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT cho bảng `project_support_allowances`
--
ALTER TABLE `project_support_allowances`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Các ràng buộc cho bảng `employee_leave_balances`
--
ALTER TABLE `employee_leave_balances`
